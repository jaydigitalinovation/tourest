            ...
            <div class="detail">
              ...
              <div id="success_message"></div>
                <div class="form"> 
                  ...
                  <form method="post" enctype="multipart/form-data" id="addData" action="{{url('/admin/store_add_aboutus_video_info')}}">  
                  	...
                  	@csrf
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="video" class="video" onchange="readURL1(this);">
