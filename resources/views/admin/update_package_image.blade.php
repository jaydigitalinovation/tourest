 ...
 -->
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/admin/store_update_package_image')}}/{{$id}}" enctype="multipart/form-data">  

                  	@csrf

                            <div class="part">
                              <div class="col-md-12 label">
                                 <label>Package_image</label>
                              </div>
                              <div class="col-md-12">
                                 ...
                                 <input type="hiddden" name="oldimage" value="{{$multi_image}}">
                               </div>   
                            </div>
