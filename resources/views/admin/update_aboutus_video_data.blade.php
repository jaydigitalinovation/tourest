...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
  ...
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/admin/store_update_aboutus_video_data')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                            ...
                            <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="video" onchange="readURL1(this);" value="">
                                 <img id="blah1" src="/uploads/{{$video}}" width="100px" height="100px" alt="">
