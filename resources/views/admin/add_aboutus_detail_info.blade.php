            ...
            <div class="detail">
              ...
              <div id="success_message"></div>
                <div class="form"> 
                  ...
                  <form method="post" enctype="multipart/form-data" id="addData" action="{{url('/admin/store_add_aboutus_detail_info')}}">  
                  	...
                  	@csrf
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="count" name="count" value="" class="count">
