...
@if(session()->has('error'))
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="{{url('/admin/package')}}"><span>Package</span></a>
            </li>
         </ul>
        </div>
  ...
  <div id="saveform_errList"></div>
          <div class="mt-5">
              <div class="list1">
                  ...
                  <button class="btn1"><a href="{{url('/admin/add_package_info')}}" style="color:black;">ADD</a></button>
              </div>
                      ...
                      <tbody>
                          <tr class="data_{{$u->id}}">
                            ...
                            <td>
                              ...
                              <td>{{$u->duration}}</td>
                              <td>
                                <button class="btn2 glow-on-hover"><a href="{{url('/admin/update_package_data')}}/{{$u->id}}"><i class="fal fa-pencil"></i></a></button>
                              </td>
                              <td>
                                <button class="glow-on-hover"><a href="{{url('/admin/delete_package_data')}}/{{$u->id}}"><i class="fal fa-trash-alt"></i></a></button>
