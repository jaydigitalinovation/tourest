...
@if(session()->has('error'))
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="{{url('/admin/reviews')}}"><span>Clients Reviews</span></a>
            </li>
         </ul>
        </div>
 <div class="page title1" style="display: block;">
  <div id="saveform_errList"></div>
          <div class="mt-5">
              <div class="list1">
                  <h4 class="mb-4">Reviews List</h4>
                  <button class="btn1"><a href="{{url('/admin/add_reviews_info')}}" style="color:black;">ADD</a></button>
              </div>
                      ...
                      <tbody>
                          <tr class="data_{{$u->id}}">
                            ...
                            <td>
                              ...
                              <td>{{$u->description}}</td>
                              <td>
                                <button class="btn2 glow-on-hover"><a href="{{url('/admin/update_reviews_data')}}/{{$u->id}}"><i class="fal fa-pencil"></i></a></button>
                              </td>
                              <td>
                                <button class="glow-on-hover"><a href="{{url('/admin/delete_reviews_data')}}/{{$u->id}}"><i class="fal fa-trash-alt"></i></a></button>
