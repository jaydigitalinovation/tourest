...
@if(session()->has('error'))
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href="{{url('/admin/choose_image')}}"><span>Choose Image</span></a>
            </li>
         </ul>
        </div>
 <div class="page title1" style="display: block;">
  <div id="saveform_errList"></div>
          <div class="mt-5">
              <div class="list1">
                  <h4 class="mb-4">Choose Image List</h4>
                  <!-- <button class="btn1"><a href="{{url('/admin/add_choose_image_info')}}" style="color:black;">ADD</a></button> -->
              </div>
                  ...
                  <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                          <tr class="data_{{$u->id}}">
                            <td>{{$key+1}}</td>
                            <td>
                              <img src="/uploads/{{$u->image}}" width="400" height="400">
                            </td>
                              <td>{{$u->title}}</td>
                              <td>
                                <button class="btn2 glow-on-hover"><a href="{{url('/admin/update_choose_image_data')}}/{{$u->id}}"><i class="fal fa-pencil"></i></a></button>
                              </td>
                              <td>
                                <!-- <button class="glow-on-hover"><a href="{{url('/admin/delete_choose_image_data')}}/{{$u->id}}"><i class="fal fa-trash-alt"></i></a></button> -->
